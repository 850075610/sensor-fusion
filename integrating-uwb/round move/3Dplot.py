...
df = pd.read_csv('roundPose2503.csv')
...
ax.legend((start, end, real, tag),
          ("Start", "End", "Pose estimation based only on IMU and Odometry", "Calculated tag (Real movement)"), loc=0)
# plt.show()
plt.savefig('round.png', bbox_inches='tight', dpi=100)
